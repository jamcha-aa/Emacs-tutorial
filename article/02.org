...
** 1. たくさん失敗する
   ...
   「エラーが出ないな」「計算の順番変えたからね」「順番？」「Emacsについてる電卓 (~M-x calc~) とEmacsのプログラムは符号の場所が違うんだ。だからさっきは電卓のつもりで入力してエラーが出た」「ふむ」「失敗しても平気なのがコンピュータで遊ぶ良いところだと思います」「[[https://www.google.com/about/appsecurity/play-rewards/][失敗を見つけると賞金をくれる会社]]もあるくらいだしな」「そうそう。どんどん失敗しよう」
